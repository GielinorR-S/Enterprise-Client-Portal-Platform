        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ClientOrganisationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ClientOrganisations_ClientOrganisationId",
                        column: x => x.ClientOrganisationId,
                        principalTable: "ClientOrganisations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClientOrganisationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_ClientOrganisations_ClientOrganisationId",
                        column: x => x.ClientOrganisationId,
                        principalTable: "ClientOrganisations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_ClientOrganisations_ClientOrganisationId",
                        column: x => x.ClientOrganisationId,
                        principalTable: "ClientOrganisations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientOrganisations_PrimaryContactId",
                table: "ClientOrganisations",
                column: "PrimaryContactId");

            migrationBuilder.CreateIndex(
                name: "IX_Documents_ClientOrganisationId",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_ClientOrganisationId",
                table: "Requests",
                column: "ClientOrganisationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ClientOrganisationId",
                table: "Users",
                column: "ClientOrganisationId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClientOrganisations_Users_PrimaryContactId",
                table: "ClientOrganisations",
                column: "PrimaryContactId",
                principalTable: "Users",
                principalColumn: "Id",
